Contributing to PeepCoin2 Core
============================

The PeepCoin2 Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PeepCoin2 Core project, and is not to be
confused with overall PeepCoin2 Network Protocol consensus changes.

Whether a pull request is merged into PeepCoin2 Core rests with the project merge
...
Patches that change PeepCoin2 consensus rules are considerably more involved than
...
Where a patch set proposes to change the PeepCoin2 consensus, it must have been
...
The project leader is the release manager for each PeepCoin2 Core release.
