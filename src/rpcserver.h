...
/**
 * PeepCoin2 RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzpp2seed(const UniValue& params, bool fHelp);
extern UniValue getzpp2seed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzpp2(const UniValue& params, bool fHelp);
extern UniValue dzpp2state(const UniValue& params, bool fHelp);
