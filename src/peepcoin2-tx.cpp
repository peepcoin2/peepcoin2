...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PeepCoin2 Core peepcoin2-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  peepcoin2-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded peepcoin2 transaction") + "\n" +
                               "  peepcoin2-tx [options] -create [commands]   " + _("Create hex-encoded peepcoin2 transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded peepcoin2 transaction
