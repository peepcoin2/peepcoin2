...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop PeepCoin2 server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "PeepCoin2 server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PeepCoin2 features */
        {"peepcoin2", "masternode", &masternode, true, true, false},
        {"peepcoin2", "listmasternodes", &listmasternodes, true, true, false},
        {"peepcoin2", "getmasternodecount", &getmasternodecount, true, true, false},
        {"peepcoin2", "masternodeconnect", &masternodeconnect, true, true, false},
        {"peepcoin2", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"peepcoin2", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"peepcoin2", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"peepcoin2", "masternodecurrent", &masternodecurrent, true, true, false},
        {"peepcoin2", "masternodedebug", &masternodedebug, true, true, false},
        {"peepcoin2", "startmasternode", &startmasternode, true, true, false},
        {"peepcoin2", "createmasternodekey", &createmasternodekey, true, true, false},
        {"peepcoin2", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"peepcoin2", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"peepcoin2", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"peepcoin2", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"peepcoin2", "getmasternodescores", &getmasternodescores, true, true, false},
        {"peepcoin2", "mnbudget", &mnbudget, true, true, false},
        {"peepcoin2", "preparebudget", &preparebudget, true, true, false},
        {"peepcoin2", "submitbudget", &submitbudget, true, true, false},
        {"peepcoin2", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"peepcoin2", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"peepcoin2", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"peepcoin2", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"peepcoin2", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"peepcoin2", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"peepcoin2", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"peepcoin2", "checkbudgets", &checkbudgets, true, true, false},
        {"peepcoin2", "mnsync", &mnsync, true, true, false},
        {"peepcoin2", "spork", &spork, true, true, false},
        {"peepcoin2", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzpp2seed", &getzpp2seed, false, false, true},
        {"zerocoin", "setzpp2seed", &setzpp2seed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzpp2", &searchdzpp2, false, false, true},
        {"zerocoin", "dzpp2state", &dzpp2state, false, false, true}
...
{
    return "> peepcoin2-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6659/\n";
}
