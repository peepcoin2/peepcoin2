...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 PP2 - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of peepcoin2.
