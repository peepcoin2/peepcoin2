...
/* PeepCoin2 GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "PeepCoin2"
#define QAPP_ORG_DOMAIN "peepcoin2.org"
#define QAPP_APP_NAME_DEFAULT "PeepCoin2-Qt"
#define QAPP_APP_NAME_TESTNET "PeepCoin2-Qt-testnet"
