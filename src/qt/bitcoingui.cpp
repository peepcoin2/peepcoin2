                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PeepCoin2 Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PeepCoin2 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and peepcoin2: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zPP2"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PeepCoin2 Core"), this);
    aboutAction->setStatusTip(tr("Show information about PeepCoin2 Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PeepCoin2"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PeepCoin2 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PeepCoin2 addresses"));
    ...
    openAction->setStatusTip(tr("Open a PeepCoin2: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PeepCoin2 Core help message to get a list with possible PeepCoin2 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PeepCoin2 Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PeepCoin2 network", "", count));
}
...
{
    QString strTitle = tr("PeepCoin2 Core"); // default title
