...
/** Utility functions used by the PeepCoin2 Qt UI.
 */
namespace GUIUtil
{
...
// Render PeepCoin2 addresses in monospace font
...
// Parse "peepcoin2:" URI into recipient object, return true on successful parsing
