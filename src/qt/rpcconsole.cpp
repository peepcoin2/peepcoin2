                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzPP2PathCustom = GetArg("-zpp2backuppath", "");
    ...
    if(!strzPP2PathCustom.empty()) {
        ui->wallet_customzpp2backuppath->setText(QString::fromStdString(strzPP2PathCustom));
        ui->wallet_customzpp2backuppath_label->setVisible(true);
        ui->wallet_customzpp2backuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzPP2PathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the PeepCoin2 RPC console.") + "<br>" +
