...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::PP2);
    ...
    if (!settings.contains("nAnonymizePeepCoin2Amount"))
        settings.setValue("nAnonymizePeepCoin2Amount", 1000);

    nAnonymizePeepCoin2Amount = settings.value("nAnonymizePeepCoin2Amount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizePeepCoin2Amount"))
        SoftSetArg("-anonymizepeepcoin2amount", settings.value("nAnonymizePeepCoin2Amount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in peepcoin2.cpp during shotdown to also remove the window positions
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case AnonymizePeepCoin2Amount:
            return QVariant(nAnonymizePeepCoin2Amount);
        case Listen:
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case AnonymizePeepCoin2Amount:
            nAnonymizePeepCoin2Amount = value.toInt();
            settings.setValue("nAnonymizePeepCoin2Amount", nAnonymizePeepCoin2Amount);
            emit anonymizePeepCoin2AmountChanged(nAnonymizePeepCoin2Amount);
            break;
        case CoinControlFeatures:
