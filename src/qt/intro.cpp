...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("PeepCoin2 Core"),
     ...
     * override -datadir in the peepcoin2.conf file in the default data directory
     * (to be consistent with peepcoin2d behavior)
     */
    if (dataDir != getDefaultDataDirectory())
