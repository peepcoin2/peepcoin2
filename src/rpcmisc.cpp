...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total peepcoin2 balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zPP2supply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zPP2 denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zPP2 denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zPP2 denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zPP2 denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zPP2 denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zPP2 denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zPP2 denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zPP2 denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zPP2 denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in peepcoin2/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in peepcoin2/kb\n"
    ...
    UniValue zpp2Obj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zpp2Obj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zpp2Obj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.push_back(Pair("zPP2supply", zpp2Obj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"peepcoin2address\"\n"
            "\nReturn information about the given peepcoin2 address.\n"

            "\nArguments:\n"
            "1. \"peepcoin2address\"     (string, required) The peepcoin2 address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"peepcoin2address\", (string) The peepcoin2 address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: PeepCoin2 address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
        throw runtime_error(
            ...
            "2. \"keys\"       (string, required) A json array of keys which are peepcoin2 addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) peepcoin2 address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"peepcoin2address\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"peepcoin2address\"  (string, required) The peepcoin2 address to use for the signature.\n"
