...
#ifndef PeepCoin2_STAKEINPUT_H
#define PeepCoin2_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZPP2() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zPP2Stake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zpp2, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZPP2() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZPP2() override { return false; }
};


#endif //PeepCoin2_STAKEINPUT_H
