...
#ifndef PeepCoin2_ZPP2WALLET_H
#define PeepCoin2_ZPP2WALLET_H
...
public:
    CzPP2Wallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZPP2(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZPP2(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //PeepCoin2_ZPP2WALLET_H
