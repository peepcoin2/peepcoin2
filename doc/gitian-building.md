...
*Setup instructions for a gitian build of PeepCoin2 using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the PeepCoin2
...
- [Building PeepCoin2](#building-peepcoin2)
...
Clone the git repositories for peepcoin2 and gitian and then checkout the peepcoin2 version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/peepcoin2-crypto/peepcoin2.git
cd peepcoin2
...
Follow the instructions in [doc/release-process.md](release-process.md) in the peepcoin2 repository
...
To build PeepCoin2 (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the peepcoin2 repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/peepcoin2/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/peepcoin2-crypto/peepcoin2
...
For example:
```bash
URL=https://github.com/crowning-/peepcoin2.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit peepcoin2=${COMMIT} --url peepcoin2=${URL} ../peepcoin2/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit peepcoin2=${COMMIT} --url peepcoin2=${URL} ../peepcoin2/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit peepcoin2=${COMMIT} --url peepcoin2=${URL} ../peepcoin2/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/peepcoin2-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/peepcoin2-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/peepcoin2-build.assert
```
...
[peepcoin2/gitian.sigs](https://github.com/peepcoin2-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
