...
PeepCoin2 now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<peepcoin2_address\> \<monthly_payment_peepcoin2\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ PeepCoin2, _12_ times over the course of a year totaling _24000_ PeepCoin2.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<peepcoin2_address\> \<monthly_payment_peepcoin2\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` PeepCoin2.
