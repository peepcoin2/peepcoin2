...
In order to support loading of multiple wallets in peepcoin2-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is peepcoin2.cpp.
...
Changes to peepcoin2.cpp
----------------------
peepcoin2.cpp is the entry point into peepcoin2-qt, and as such, will require some minor modifications to provide hooks for
